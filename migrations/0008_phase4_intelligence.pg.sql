...
ALTER TABLE products ADD COLUMN IF NOT EXISTS stock_status TEXT NOT NULL DEFAULT 'unknown';
...
CREATE TABLE IF NOT EXISTS price_baselines (
  product_id INTEGER PRIMARY KEY REFERENCES products(id) ON DELETE CASCADE,
  median_10d DOUBLE PRECISION,
  low_10d DOUBLE PRECISION,
  median_30d DOUBLE PRECISION,
  median_90d DOUBLE PRECISION,
